...
export interface Env {
  ...
  LIVE_FLIGHT_MONTHLY_REQUEST_BUDGET?: string;
  LIVE_FLIGHT_MIN_REFRESH_MINUTES?: string;
  LIVE_FLIGHT_MAX_BATCH_SIZE?: string;
  LIVE_FLIGHT_BETA_ONLY?: string;
  LIVE_FLIGHT_BETA_USER_IDS?: string;
  AERODATABOX_RAPIDAPI_KEY?: string;
  AERODATABOX_RAPIDAPI_HOST?: string;
  AERODATABOX_API_TIMEOUT_MS?: string;
  AI_ENABLED?: string;
