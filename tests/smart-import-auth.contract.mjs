...
assert(sw.includes("const CACHE='tripto-shell-product-v2-welcome-passport-v3-responsive'")&&sw.includes('/canonical-host.js')&&sw.includes('/manual-booking-attachments.js')&&sw.includes('await cache.put(request,response.clone())'),'service worker runtime cache updated');
