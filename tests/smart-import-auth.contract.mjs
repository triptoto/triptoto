...
assert(sw.includes("const CACHE='tripto-shell-product-v2-phosphor-v39'")&&sw.includes('/canonical-host.js')&&sw.includes('/manual-booking-attachments.js')&&sw.includes('/vendor/phosphor/Phosphor-Fill.woff2')&&sw.includes('await cache.put(request,response.clone())'),'service worker runtime cache updated');
