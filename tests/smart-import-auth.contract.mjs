...
assert(sw.includes("const CACHE='tripto-shell-product-v29-row-width'")&&sw.includes('/canonical-host.js')&&sw.includes('/manual-booking-attachments.js')&&!sw.includes('/vendor/phosphor/')&&sw.includes('await cache.put(request,response.clone())'),'service worker runtime cache updated');
