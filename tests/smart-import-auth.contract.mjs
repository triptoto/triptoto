...
assert(sw.includes("const CACHE='tripto-shell-product-v2-email-inbox-v1'")&&sw.includes('/manual-booking-attachments.js')&&sw.includes('await cache.put(request,response.clone())'),'service worker runtime cache updated');
