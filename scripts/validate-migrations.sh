...
with tempfile.NamedTemporaryFile(suffix='.sqlite') as tmp:
    ...
    try:
        ...
        required={'journey_groups','journey_group_items','traveler_booking_details','trip_contacts','trip_time_markers','trip_sync_cursors','sync_idempotency','trip_health_runs','planning_collections','planning_stops'}
