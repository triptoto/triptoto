...
- Phosphor is the official UI icon system: Regular for normal controls and travel categories, Fill for selected/current states. Custom SVGs are limited to weather, destination, and branded illustrations. No emoji or external icon request is used.
