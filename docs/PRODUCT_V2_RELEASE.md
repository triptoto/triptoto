...
Returning travelers land on the active trip, nearest upcoming trip, or most relevant recent trip. Primary navigation is `Trip | Alerts | + | To-do | Account`. The plus menu contains only Add Booking and Create New Trip.
