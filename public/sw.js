const CACHE='tripto-shell-beta-milestone-2';
const ASSETS=['/','/app','/index.html','/app.css','/app-v3.css','/app-v4.css','/app-v5.css','/app-v6.css','/app-v7.css','/app-beta.css','/app-milestone2.css','/app.js','/manifest.webmanifest'];
