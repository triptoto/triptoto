const CACHE='tripto-shell-product-v250-header-navigation';
...
const ASSETS=['/','/app','/index.html','/shell-update.js','/canonical-host.js','/mobile-routes.js','/legal-navigation.css','/legal-navigation.js','/mobile-trip-rules.js','/mobile-app.min.css','/google-auth-client.js','/manual-booking-attachments.js','/mobile-app.min.js','/icons/tripto-system.svg','/manifest.webmanifest','/assets/google-g.svg','/assets/trips-bg.jpg','/favicon.svg','/favicon-mask.svg','/favicon-32.png','/favicon-16.png','/apple-touch-icon.png','/icon-192.png','/icon-512.png'];
